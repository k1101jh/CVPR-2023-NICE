...
def get_device_map(checkpoint, devices):
    device_map = {
        ...
        "Salesforce/blip2-flan-t5-xl": {
            ...
            "vision_model.encoder.layers.16": devices[0],
            "vision_model.encoder.layers.17": devices[0],
            "vision_model.encoder.layers.18": devices[1],
            "vision_model.encoder.layers.19": devices[1],
            "vision_model.encoder.layers.20": devices[1],
            "vision_model.encoder.layers.21": devices[1],
            "vision_model.encoder.layers.22": devices[1],
            "vision_model.encoder.layers.23": devices[1],
            "vision_model.encoder.layers.24": devices[1],
            "vision_model.encoder.layers.25": devices[1],
            "vision_model.encoder.layers.26": devices[1],
            "vision_model.encoder.layers.27": devices[1],
            ...
            "vision_model.encoder.layers.33": devices[1],
            "vision_model.encoder.layers.34": devices[1],
            "vision_model.encoder.layers.35": devices[2],
            "vision_model.encoder.layers.36": devices[2],
            "vision_model.encoder.layers.37": devices[2],
            "vision_model.encoder.layers.38": devices[2],
            "vision_model.post_layernorm": devices[2],
            "qformer": devices[2],
            "language_projection": devices[2],
            "language_model.shared": devices[2],
            "language_model.decoder.embed_tokens": devices[2],
            "language_model.encoder.embed_tokens": devices[2],
            "language_model.encoder.block.0": devices[2],
            "language_model.encoder.block.1": devices[2],
            "language_model.encoder.block.2": devices[2],
            "language_model.encoder.block.3": devices[2],
            "language_model.encoder.block.4": devices[2],
            "language_model.encoder.block.5": devices[2],
            ...
            "language_model.encoder.block.21": devices[3],
            "language_model.encoder.block.22": devices[3],
            ...
            "language_model.lm_head": devices[2],
        },
